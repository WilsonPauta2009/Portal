<%@ Page Language="C#" MasterPageFile="~/PlantillaInformes.master" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="index" Title="Index..." %>
            ...
            <tr>
                <td align="center" valign="middle" style="width: 340px">
                    <table id="Tab002" border="0" cellpadding="3" cellspacing="0" style="width: 340px;">
                        ...
                        <tr>
                            <td align="right" valign="middle" style="border-top: 1px solid #FFFFFF; border-color: #003366; width: 107px;">
                            ...
                            <td align="left" valign="middle" style="border-color: #003366; border-top-style: solid; border-top-width: 1px">
                        ...
                        <tr>
                            <td align="right" valign="middle" style="width: 107px">
                        ...
                        <tr >
                            <td style="border-bottom: 1px solid #FFFFFF; border-color: #003366; width: 107px;">
                            </td>
                            <td align="left" valign="bottom" 
                                style="border-color: #003366; border-bottom-style: solid; border-bottom-width: 1px">
