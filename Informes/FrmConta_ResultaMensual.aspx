<%@ Page Title="Centro de Costos" Language="C#" MasterPageFile="~/PlantillaInformes.master" AutoEventWireup="true" CodeFile="FrmConta_ResultaMensual.aspx.cs" Inherits="FrmConta_ResultaMensual" %>
    ...
    <table id="TabCont" border="0" cellpadding="0" cellspacing="0" style="width: 100%" bgcolor="White">
                                            ...
                                            <tr>
                                                <td style="width: 75px">
                                                    <ig:WebDateTimeEditor ID="WdtFeIn" runat="server" EditModeFormat="dd/MM/yyyy" 
                                                        ...
                                                        onblur="this.style.background='white'" TabFrmConta_ResultaMensual="5">
                            ...
                            <table id="TabRubr" cellspacing="1" style="width: 100%" cellpadding="1">
                                <tr>
                                    <td align="left" valign="middle">
                                        <asp:RadioButton ID="RdoBtnCeCo" runat="server" AutoPostBack="True"
                                            Checked="True" Font-Names="Arial" Font-Size="8pt" GroupName="GrpRubr"
                                            Text="CENTRO DE COSTOS" ForeColor="#CCFFCC" />
                                    </td>
                                    <td align="left" valign="middle">
                                        <asp:RadioButton ID="RdoBtnLine" runat="server" AutoPostBack="True"
                                            Font-Names="Arial" Font-Size="8pt" GroupName="GrpRubr"
                                            Text="LINEAS" Visible="False" ForeColor="#CCFFCC" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle">
                                        <asp:DropDownList ID="WebCeCo" runat="server" Width="280px" Font-Names="Courier New" Font-Size="9pt">
                                        </asp:DropDownList>
                                    </td>
                                    <td align="left" valign="middle">
                                        <asp:DropDownList ID="WebLine" runat="server" Visible="False" Width="280px" Font-Names="Courier New" Font-Size="9pt">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
        ...
        <tr>
            <td>
                <rsweb:ReportViewer ID="RptView" runat="server" Width="100%" 
                    ...
                    <LocalReport ReportPath="Informes\InfConta_ResultaMensual.rdlc" 
                        DisplayName="Perdidas_Ganancias">
                        <DataSources>
        ...
        <tr>
            <td align="right" valign="bottom" height="10px">
                <asp:ObjectDataSource ID="ODts" runat="server" SelectMethod="Inf_ContResu" 
                    TypeName="ClsInfo">
                    <SelectParameters>
