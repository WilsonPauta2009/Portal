...
public partial class FrmVentasPresupuestos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {*/
            if (!Page.IsPostBack)
            {
                ...
                TxtTipo.Text = "AREA";
                TxtTiRe.Text = rdoBtnTipo.SelectedValue;
            }
        /*}
    ...
    {
        TxtLeye.Text = rdoBtnTipo.Items[rdoBtnTipo.SelectedIndex].Text + "\n";
        
        TxtLine.Text = WebLine.SelectedValue;
        TxtTipo.Text = WebTipo.SelectedValue;
        TxtVent.Text = WebVent.SelectedValue;

        if (WebLine.SelectedValue == "%") TxtLine.Text = "%";
        else { /*TxtLeye.Text = WebLine.Items[WebLine.SelectedIndex].Value.Trim();*/  TxtLeye.Text += WebLine.Items[WebLine.SelectedIndex].Text.Trim() + "\n"; }

        TxtLeye.Text += WebTipo.Items[WebTipo.SelectedIndex].Text.Trim() + " - ";
        TxtLeye.Text += WebVent.Items[WebVent.SelectedIndex].Text.Trim();
