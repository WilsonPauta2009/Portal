...
<script runat="server">
    ...
    protected void Btn_Click(object sender, EventArgs e)
    {
        if (Cmb.SelectedIndex >= 0)
        {
            ...
            Tabu = Info.GetMiscelaneosFactory(Cmb.Items[Cmb.SelectedIndex].Value.ToString(), "DUNIA");
            Data();
            ...
            //        break;
            //    case "SP_TAB_LOG04":
            //        Tabu = Info.GetMiscelaneos1(Cmb.Items[Cmb.SelectedIndex].Value.ToString(), "", WdtFeIn.Date, WdtFeFn.Date);
            //        Data();
            //        break;
            //    case "SP_TAB_LOG07_1":
            //        Tabu = Info.GetMiscelaneos1(Cmb.Items[Cmb.SelectedIndex].Value.ToString(), "", WdtFeIn.Date, WdtFeFn.Date);
            ...
            //        break;
            //    case "SP_TAB_LOG09":
            //        Tabu = Info.GetMiscelaneos2(Cmb.Items[Cmb.SelectedIndex].Value.ToString(), "");
            //        Data();
            //        break;
            //    case "SP_TAB_LOG10":
            //        Tabu = Info.GetMiscelaneos3(Cmb.Items[Cmb.SelectedIndex].Value.ToString(), "", WdtFeFn.Date);
            //        Data();
            //        break;
            //}
                    ...
                    <tr>
                        ...
                        <td style="height: 53px">
                            <asp:DropDownList ID="Cmb" runat="server" Font-Names="Tahoma" Font-Size="8pt" Font-Bold="True" Width="400px">
                                <asp:ListItem Value="SP_ITEMS_INGRESO">ITEMS: Existencias y Ultimo Ingreso</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td style="height: 53px">
