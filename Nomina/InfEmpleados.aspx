<%@ Page Language="C#" MasterPageFile="~/PlantillaNomina.master" AutoEventWireup="true" CodeFile="InfEmpleados.aspx.cs" Inherits="InfEmpleados" Title="Informe: Empleados..." %>
                    ...
                    <tr>
                        <td style="width: 50%" align="center" valign="middle">
                            <asp:Button ID="BtnExpo" runat="server" CausesValidation="False" Font-Bold="True"
                                Font-Names="Arial Narrow" Font-Size="8pt" OnClick="BtnExpo_Click" TabIndex="1"
                                Text="Exportar a MS Excel" />
                        </td>
                        <td align="center" valign="middle">
                            <asp:Button ID="BtnCerr" runat="server" CausesValidation="False" Font-Bold="True"
                                Font-Names="Arial Narrow" Font-Size="8pt" OnClick="BtnCerr_Click" TabIndex="7"
                                Text="CERRAR" />
                        </td>
                    </tr>
                </table>
